...
<Guardian>
	<div class="h-screen bg-gray-50 flex items-center justify-center">
		<!-- Left Sidebar -->
		<div
			class="w-1/5 bg-gradient-to-br from-purple-600 to-purple-700 p-8 flex flex-col justify-center text-white h-full"
		>
			<div class="mb-8">
		...
		<div class="flex items-center justify-center h-full">
			<div class="bg-white shadow-xl w-full max-w-2xl h-screen pt-24">
				<!-- Header -->
				<div class="flex items-center justify-between p-6 border border-gray-100">
